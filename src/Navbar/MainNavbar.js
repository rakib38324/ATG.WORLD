      ...
      <Modal.Body>
        <div>
          <form className="mt-10 " onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="d-flex justify-content-between m-3 my-4">
            <Button variant="primary" className="fs-4 p-2 px-4 rounded-pill">Create Account</Button>
                <Link to="/" className="my-auto fs-5 text-black fw-bold">
              Or, Sign In
            </Link>
            </div>
            ...
            <div className="w-100 border d-flex justify-content-center py-2 my-4"  style={{ cursor: "pointer" }}>
              <FaFacebook className="fs-2 text-primary me-2 my-auto"></FaFacebook>
              <p className="fs-4 my-auto">Sign up with Facebook</p>
            </div>

            <div className="w-100 border d-flex justify-content-center py-2 mt-3"  style={{ cursor: "pointer" }}>
          ...
          <p className="text-center mt-5">By SignUp, you agree to our Terms & <br /> conditions, Privacy Policy </p>
        </div>
      </Modal.Body>
